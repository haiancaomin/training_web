    ...
    >
      <el-form :model="ruleForm" :rules="rules" ref="ruleForm" id="loginForm">
        ...
        <el-form-item prop="qq">
          <el-input placeholder="请输入QQ号" v-model="ruleForm.qq">
            <i slot="prefix" class="iconfont">&#xe605;</i>
          </el-input>
        </el-form-item>
    ...
    return {
      ...
      rules: {
        ...
        qq: [
          ...
          { min: 1, max: 20, message: "长度不正确", trigger: "blur" }
        ],
        phone: [
        ...
        if (valid) {
          this.$ajax({
            ...
            url: `${this.baseURL}/zjsxpt/login_register.do?name=${
              ...
              this.ruleForm.phone
            }&code=${this.ruleForm.code}&qq=${this.ruleForm.qq}`
          })
            .then(res => {
              if (res.data.data == 0) {
                var that = this;
...
@font-face {
  ...
  src: url('//at.alicdn.com/t/font_1131189_2exgm3zvv1b.eot');
  src: url('//at.alicdn.com/t/font_1131189_2exgm3zvv1b.eot?#iefix') format('embedded-opentype'),
  url('//at.alicdn.com/t/font_1131189_2exgm3zvv1b.woff2') format('woff2'),
  url('//at.alicdn.com/t/font_1131189_2exgm3zvv1b.woff') format('woff'),
  url('//at.alicdn.com/t/font_1131189_2exgm3zvv1b.ttf') format('truetype'),
  url('//at.alicdn.com/t/font_1131189_2exgm3zvv1b.svg#iconfont') format('svg');
}
.iconfont {
