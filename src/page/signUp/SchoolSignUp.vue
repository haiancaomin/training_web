              ...
              <li class="form1">
                <div class="info-need">
                  <el-form-item label="课程选择" prop="course1">
                    ...
                    <span class="el-icon-minus" id="el-icon-minus1" @click="deletes1()" v-if="del1"></span>
                  </el-form-item>

                  <el-form-item label="培训地点" prop="Address1">
                    <el-select v-model="ruleForm.Address1" placeholder="请选择培训地点">
                      <el-option
                  ...
                  <el-form-item label="时间选择" prop="time1">
                    <el-select v-model="ruleForm.time1" placeholder="请选择培训时间">
                      <el-option
                  ...
                  <el-form-item label="套餐选择" prop="meal1">
                    <el-select v-model="ruleForm.meal1" placeholder="请选择套餐">
                      <el-option
              ...
              <li class="form2">
                <div class="info-need">
                  <el-form-item label="课程选择" prop="course2">
                    ...
                    <span class="el-icon-minus" id="el-icon-minus2" @click="deletes2()" v-if="del2"></span>
                  </el-form-item>

                  <el-form-item label="培训地点" prop="Address2">
                    <el-select v-model="ruleForm.Address2" placeholder="请选择培训地点">
                      <el-option
                  ...
                  <el-form-item label="时间选择" prop="time2">
                    <el-select v-model="ruleForm.time2" placeholder="请选择培训时间">
                      <el-option
                  ...
                  <el-form-item label="套餐选择" prop="meal2">
                    <el-select v-model="ruleForm.meal2" placeholder="请选择套餐">
                      <el-option
              ...
              <li class="form3">
                <div class="info-need">
                  <el-form-item label="课程选择" prop="course3" id="education">
                    ...
                    <span class="el-icon-minus" id="el-icon-minus3" @click="deletes3()" v-if="del3"></span>
                  </el-form-item>

                  <el-form-item label="培训地点" prop="Address3">
                    <el-select v-model="ruleForm.Address3" placeholder="请选择培训地点">
                      <el-option
                  ...
                  <el-form-item label="时间选择" prop="time3">
                    <el-select v-model="ruleForm.time3" placeholder="请选择培训时间">
                      <el-option
                  ...
                  <el-form-item label="套餐选择" prop="meal3">
                    <el-select v-model="ruleForm.meal3" placeholder="请选择套餐">
                      <el-option
              ...
              <li class="form4">
                <div class="info-need">
                  <el-form-item label="课程选择" prop="course4" id="education">
                    ...
                    <span class="el-icon-minus" id="el-icon-minus4" @click="deletes4()" v-if="del4"></span>
                  </el-form-item>

                  <el-form-item label="培训地点" prop="Address4">
                    <el-select v-model="ruleForm.Address4" placeholder="请选择培训地点">
                      <el-option
                  ...
                  <el-form-item label="时间选择" prop="time4">
                    <el-select v-model="ruleForm.time4" placeholder="请选择培训时间">
                      <el-option
                  ...
                  <el-form-item label="套餐选择" prop="meal4">
                    <el-select v-model="ruleForm.meal4" placeholder="请选择套餐">
                      <el-option
